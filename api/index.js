...
async function uploadLargeFile(filePath, originalName, chatId) {
  ...
  // Note: Telegram has a 2GB limit per file, so we'll store metadata and use multiple messages
...
console.log('📊 Features: 4GB uploads, streaming, security, rate limiting');
